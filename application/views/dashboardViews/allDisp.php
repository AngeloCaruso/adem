        ...
        <div class="modal-content col-md-10 mr-auto ml-auto">
            ...
            <div class="modal-body">
                <div class="input-group">
                    ...
                    <input class="form-control addDispNombre" type="text" placeholder="Nombre del dispositivo"
                        autocomplete="off">
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                    ...
                    <input class="form-control addDispInterv" type="text" placeholder="Intervalo de envío de datos"
                        autocomplete="off">
                </div>
